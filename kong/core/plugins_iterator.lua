...
local plugin_iter_state = setmetatable({}, plugin_iter_mt)
...
local function iter_plugins_for_req(loaded_plugins, access_or_cert_ctx)
  ...
  plugin_iter_state.i                  = 0
  plugin_iter_state.ctx                = ctx
  plugin_iter_state.api                = ctx.api
  plugin_iter_state.loaded_plugins     = loaded_plugins
  plugin_iter_state.access_or_cert_ctx = access_or_cert_ctx

  return plugin_iter_state
end
